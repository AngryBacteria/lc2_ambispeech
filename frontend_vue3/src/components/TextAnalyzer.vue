<template>
  <section class="component-wrapper">
    ...
    <Button @click="analyzeText()" :disabled="(transcription.length < 1) || analysisIsLoading">Analysiere Text</Button>
